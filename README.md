...
".abc" class : 가져오기 <br />
Tag : 모든 tag <br />
Tag1 Tag2 : tag1, tag2 가져오기 <br />
Tag1 > Tag2 : tag1의 자손인 tag2 <br />
tag[attr] : attr 속성이 정의된 모든 tag <br />
tag[attr="bar"] : attr 속성이 bar 문자열과 일치하는 tag <br />
tag[attr*='bar'] : attr 속성이 bar 문자열과 부분 일치하는 tag <br />
tag[attr^='bar'] : attr 속성이 bar 문자열로 시작하는 tag <br />
tag[attr&='bar'] : attr 속성이 bar 문자열로 끝나는 tag <br />
tag#tag_id : id가 tag_id인 모든 tag <br />
...
**8일차**<br />
루프 엔지니어링은 코드 실행과 오류 수정 과정을 모두 AI로 돌리는 것으로 몇번 반복하게 하면서 진행된다
국회의원현황 홈페이지처럼 json파일로 데이터를 받을 때 여러 페이지에 걸쳐 명단을 가져오는데 payload 데이터 없이 가져오게 될 경우 1페이지의 정보만 나오게 된다.
